...
export async function forwardTelegramMessage(botToken, fromChatId, messageId, toChatId) {
    try {
...
export function extractMessageInfoFromUpdate(update) {
...
// 发送消息到 Telegram Bot
export async function sendTelegramMessage(botToken, chatId, message, parseMode = 'HTML') {
    try {
...
export function formatSecurityDataForTelegram(items, timeRange) {
    const lines = [];
...
export async function sendTelegramMessages(botToken, chatId, items, timeRange, useOpenAI = true) {
    try {
